	...
	return (
		<article id="reform">
			...
			<section>
				...
				<li className="has-tooltip" data-tooltip="Some genetic testing and cancer screenings require a close relative to have a history of illness. Insurance agencies have denied claims due to lack of legal connection">No loss of legal medical history</li>
				<li className="has-tooltip" data-tooltip="Familial separation and adoption are a traumatic events that many adoptees struggle with into adulthood">Guaranteed mental health resources</li>
				...
				<li className="has-tooltip" data-tooltip="Revocation periods vary from state-to-state. Anywhere between no period and 45 days">Standardized revocation periods</li>
				<li className="has-tooltip" data-tooltip="Agencies move pregnant people to states where they have no local support system and where the revocation periods and waiting periods favor hopeful parents">No moving parents across state lines</li>
				<li className="has-tooltip" data-tooltip="Agencies and hopeful parents actively approach expectant parents who may have no intention to relinquish in places like hospitals, churches, stores, or on the internet">No solicitation of expectant parents</li>
				<li className="has-tooltip" data-tooltip="Some agencies vary price of children based on race, age, gender, health of the child, and expectations of expectant parents. On average, white children cost 2x as much as Black children">No race/gender-based pricing of children</li>
				<li className="has-tooltip" data-tooltip="Home studies and background checks are not thorough enough and there is no check that the child is safe and thriving after adoption">Better vetting & regular wellness checks</li>
			</section>
		</article>
	)
}